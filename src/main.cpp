    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          vector<double> xy0 = getXY(car_s+30,2+4*lane_num, map_waypoints_s, map_waypoints_x, map_waypoints_y);
          vector<double> xy1 = getXY(car_s+60,2+4*lane_num, map_waypoints_s, map_waypoints_x, map_waypoints_y);
          vector<double> xy2 = getXY(car_s+90,2+4*lane_num, map_waypoints_s, map_waypoints_x, map_waypoints_y); 
